...
I used sales data from a store to predict the number of future sales using previous data and metadata. I used A/B testing to determine whether holidays and natural disasters affected the store sales. Then I applied SARIMA and XGBoost to forecast the sales. Modelling with XGBoost was better and produced a forecast with an average uncertainty of 15%.  ([GitHub Repo]([https://github.com/jcwons/BayOp](https://github.com/jcwons/TimeSeriesForecast/))).
