...
I used **sales data** from a store to forecast future sales using previous data and metadata. I used A/B testing to determine whether holidays and natural disasters affected the store sales. Then I applied SARIMA and XGBoost to forecast the sales, where XGBoost showed the best results. **Future sale numbers were predicted with an 85% accuracy including seasonal trends**.  ([GitHub Repo]([https://github.com/jcwons/BayOp](https://github.com/jcwons/TimeSeriesForecast/))).
